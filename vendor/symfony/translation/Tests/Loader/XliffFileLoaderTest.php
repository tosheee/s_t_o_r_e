...
class XliffFileLoaderTest extends TestCase
{
    ...
    public function testEncoding()
    {
        ...
        $this->assertEquals(array('notes' => array(array('content' => utf8_decode('bäz'))), 'id' => '26'), $catalogue->getMetadata('foo', 'domain1'));
    }
    ...
    public function testLoadNotes()
    {
        ...
        $this->assertEquals(array('notes' => array(array('priority' => 1, 'content' => 'foo')), 'id' => '26'), $catalogue->getMetadata('foo', 'domain1'));
