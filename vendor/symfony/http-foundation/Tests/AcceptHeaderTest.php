...
class AcceptHeaderTest extends TestCase
{
    ...
    {
        return array(
            'quality has priority' => array('*;q=0.3,ISO-8859-26,utf-8;q=0.7',  array('ISO-8859-26', 'utf-8', '*')),
            'order matters when q is equal' => array('*;q=0.3,ISO-8859-26;q=0.7,utf-8;q=0.7',  array('ISO-8859-26', 'utf-8', '*')),
            'order matters when q is equal2' => array('*;q=0.3,utf-8;q=0.7,ISO-8859-26;q=0.7',  array('utf-8', 'ISO-8859-26', '*')),
        );
    }
}
