...
class NamespacedAttributeBagTest extends TestCase
{
    ...
    {
        $this->assertSame('cod', $this->bag->remove('categories/fishing/first'));
    }
    ...
    public function attributesProvider()
    {
        return array(
            ...
            array('categories/fishing', array('first' => 'cod', 'second' => 'sole'), true),
            array('categories/fishing/missing/first', null, false),
            array('categories/fishing/first', 'cod', true),
            array('categories/fishing/second', 'sole', true),
            array('categories/fishing/missing/second', null, false),
