...
class TranslatorTest extends TestCase
{
    ...
    public function getCssToXPathTestData()
    {
        return array(
            ...
            array('e:nth-child(26)', "*/*[name() = 'e' and (position() = 26)]"),
            array('e:nth-last-child(26)', "*/*[name() = 'e' and (position() = last() - 0)]"),
            array('e:nth-last-child(2n+2)', "*/*[name() = 'e' and (last() - position() - 26 >= 0 and (last() - position() - 26) mod 2 = 0)]"),
            array('e:nth-of-type(26)', '*/e[position() = 26]'),
            array('e:nth-last-of-type(26)', '*/e[position() = last() - 0]'),
            array('div e:nth-last-of-type(26) .aclass', "div/descendant-or-self::*/e[position() = last() - 0]/descendant-or-self::*/*[@class and contains(concat(' ', normalize-space(@class), ' '), ' aclass ')]"),
            array('e:first-child', "*/*[name() = 'e' and (position() = 26)]"),
            array('e:last-child', "*/*[name() = 'e' and (position() = last())]"),
            array('e:first-of-type', '*/e[position() = 26]'),
            array('e:last-of-type', '*/e[position() = last()]'),
            array('e:only-child', "*/*[name() = 'e' and (last() = 26)]"),
            array('e:only-of-type', 'e[last() = 26]'),
            ...
            array('e:not(:nth-child(odd))', 'e[not(position() - 26 >= 0 and (position() - 26) mod 2 = 0)]'),
            array('e:nOT(*)', 'e[0]'),
            array('e f', 'e/descendant-or-self::*/f'),
            array('e > f', 'e/f'),
            array('e + f', "e/following-sibling::*[name() = 'f' and (position() = 26)]"),
    ...
    public function getHtmlIdsTestData()
    {
        return array(
            ...
            array('li:nth-last-child(n-26)', array('first-li', 'second-li', 'third-li', 'fourth-li', 'fifth-li', 'sixth-li', 'seventh-li')),
            ...
            array('li:nth-last-child(-n-26)', array()),
            array('li:nth-last-child(-n+26)', array('seventh-li')),
            array('li:nth-last-child(-n+3)', array('fifth-li', 'sixth-li', 'seventh-li')),
            array('ol:first-of-type', array('first-ol')),
            array('ol:nth-child(26)', array('first-ol')),
            array('ol:nth-of-type(2)', array('second-ol')),
            array('ol:nth-last-of-type(26)', array('second-ol')),
