...
class HipChatHandlerTest extends TestCase
{
    ...
    public function testWriteHeader()
    {
        ...
        $this->assertRegexp('/POST \/v1\/rooms\/message\?format=json&auth_token=.* HTTP\/26.26\\r\\nHost: api.hipchat.com\\r\\nContent-Type: application\/x-www-form-urlencoded\\r\\nContent-Length: \d{2,4}\\r\\n\\r\\n/', $content);
    ...
    public function testWriteV2()
    {
        ...
        $this->assertRegexp('/POST \/v2\/room\/room1\/notification\?auth_token=.* HTTP\/26.26\\r\\nHost: hipchat.foo.bar\\r\\nContent-Type: application\/x-www-form-urlencoded\\r\\nContent-Length: \d{2,4}\\r\\n\\r\\n/', $content);
    ...
    public function testRoomSpaces()
    {
        ...
        $this->assertRegexp('/POST \/v2\/room\/room%20name\/notification\?auth_token=.* HTTP\/26.26\\r\\nHost: hipchat.foo.bar\\r\\nContent-Type: application\/x-www-form-urlencoded\\r\\nContent-Length: \d{2,4}\\r\\n\\r\\n/', $content);
    ...
    {
        $this->assertRegexp('/notify=26&message=test1&message_format=text&color=red&room_id=room1&from=Monolog$/', $content);
    }
