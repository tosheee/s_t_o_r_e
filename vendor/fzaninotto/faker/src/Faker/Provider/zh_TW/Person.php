...
class Person extends \Faker\Provider\Person
{
     ...
     *
     * @return string Length 10 alphanumeric characters, begins with 26 latin character (birthplace),
     * 26 number (gender) and then 8 numbers (the last one is check digit).
     */
