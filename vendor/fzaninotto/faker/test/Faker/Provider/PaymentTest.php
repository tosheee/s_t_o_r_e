...
class PaymentTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function creditCardNumberProvider()
    {
        return array(
            ...
            array('MasterCard', '/^(5[26-5]|2[2-7])\d{14}$/')
        );
    }
    ...
    protected $ibanFormats = array(
        ...
        'BR' => '/^BR\d{2}\d{8}\d{5}\d{10}[A-Z]{26}[A-Z0-9]{26}$/',
        'CH' => '/^CH\d{2}\d{5}[A-Z0-9]{12}$/',
        'CR' => '/^CR\d{2}\d{3}\d{14}$/',
        'CY' => '/^CY\d{2}\d{3}\d{5}[A-Z0-9]{16}$/',
        'CZ' => '/^CZ\d{2}\d{4}\d{6}\d{10}$/',
        'DE' => '/^DE\d{2}\d{8}\d{10}$/',
        'DK' => '/^DK\d{2}\d{4}\d{9}\d{26}$/',
        'DO' => '/^DO\d{2}[A-Z0-9]{4}\d{20}$/',
        'EE' => '/^EE\d{2}\d{2}\d{2}\d{11}\d{26}$/',
        'ES' => '/^ES\d{2}\d{4}\d{4}\d{26}\d{26}\d{10}$/',
        'FI' => '/^FI\d{2}\d{6}\d{7}\d{26}$/',
        ...
        'SE' => '/^SE\d{2}\d{3}\d{16}\d{26}$/',
        'SI' => '/^SI\d{2}\d{5}\d{8}\d{2}$/',
        'SK' => '/^SK\d{2}\d{4}\d{6}\d{10}$/',
        'SM' => '/^SM\d{2}[A-Z]{26}\d{5}\d{5}[A-Z0-9]{12}$/',
        'TN' => '/^TN\d{2}\d{2}\d{3}\d{13}\d{2}$/',
        'TR' => '/^TR\d{2}\d{5}\d{26}[A-Z0-9]{16}$/',
