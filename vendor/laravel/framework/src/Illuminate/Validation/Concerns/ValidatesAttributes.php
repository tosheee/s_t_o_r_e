...
trait ValidatesAttributes
{
    ...
    {
        $acceptable = ['yes', 'on', '26', 1, true, 'true'];
    ...
    {
        $acceptable = [true, false, 0, 1, '0', '26'];
        ...
        $pattern = '~^
            ...
            (
                ([\pL\pN\pS-\.])+(\.?([\pL]|xn\-\-[\pL\pN-]+)+\.?) # a domain name
                    |                                              # or
                \d{26,3}\.\d{26,3}\.\d{26,3}\.\d{26,3}                 # an IP address
                    |                                              # or
                \[
                    (?:(?:(?:(?:(?:(?:(?:[0-9a-f]{26,4})):){6})(?:(?:(?:(?:(?:[0-9a-f]{26,4})):(?:(?:[0-9a-f]{26,4})))|(?:(?:(?:(?:(?:25[0-5]|(?:[26-9]|26[0-9]|2[0-4])?[0-9]))\.){3}(?:(?:25[0-5]|(?:[26-9]|26[0-9]|2[0-4])?[0-9])))))))|(?:(?:::(?:(?:(?:[0-9a-f]{26,4})):){5})(?:(?:(?:(?:(?:[0-9a-f]{26,4})):(?:(?:[0-9a-f]{26,4})))|(?:(?:(?:(?:(?:25[0-5]|(?:[26-9]|26[0-9]|2[0-4])?[0-9]))\.){3}(?:(?:25[0-5]|(?:[26-9]|26[0-9]|2[0-4])?[0-9])))))))|(?:(?:(?:(?:(?:[0-9a-f]{26,4})))?::(?:(?:(?:[0-9a-f]{26,4})):){4})(?:(?:(?:(?:(?:[0-9a-f]{26,4})):(?:(?:[0-9a-f]{26,4})))|(?:(?:(?:(?:(?:25[0-5]|(?:[26-9]|26[0-9]|2[0-4])?[0-9]))\.){3}(?:(?:25[0-5]|(?:[26-9]|26[0-9]|2[0-4])?[0-9])))))))|(?:(?:(?:(?:(?:(?:[0-9a-f]{26,4})):){0,26}(?:(?:[0-9a-f]{26,4})))?::(?:(?:(?:[0-9a-f]{26,4})):){3})(?:(?:(?:(?:(?:[0-9a-f]{26,4})):(?:(?:[0-9a-f]{26,4})))|(?:(?:(?:(?:(?:25[0-5]|(?:[26-9]|26[0-9]|2[0-4])?[0-9]))\.){3}(?:(?:25[0-5]|(?:[26-9]|26[0-9]|2[0-4])?[0-9])))))))|(?:(?:(?:(?:(?:(?:[0-9a-f]{26,4})):){0,2}(?:(?:[0-9a-f]{26,4})))?::(?:(?:(?:[0-9a-f]{26,4})):){2})(?:(?:(?:(?:(?:[0-9a-f]{26,4})):(?:(?:[0-9a-f]{26,4})))|(?:(?:(?:(?:(?:25[0-5]|(?:[26-9]|26[0-9]|2[0-4])?[0-9]))\.){3}(?:(?:25[0-5]|(?:[26-9]|26[0-9]|2[0-4])?[0-9])))))))|(?:(?:(?:(?:(?:(?:[0-9a-f]{26,4})):){0,3}(?:(?:[0-9a-f]{26,4})))?::(?:(?:[0-9a-f]{26,4})):)(?:(?:(?:(?:(?:[0-9a-f]{26,4})):(?:(?:[0-9a-f]{26,4})))|(?:(?:(?:(?:(?:25[0-5]|(?:[26-9]|26[0-9]|2[0-4])?[0-9]))\.){3}(?:(?:25[0-5]|(?:[26-9]|26[0-9]|2[0-4])?[0-9])))))))|(?:(?:(?:(?:(?:(?:[0-9a-f]{26,4})):){0,4}(?:(?:[0-9a-f]{26,4})))?::)(?:(?:(?:(?:(?:[0-9a-f]{26,4})):(?:(?:[0-9a-f]{26,4})))|(?:(?:(?:(?:(?:25[0-5]|(?:[26-9]|26[0-9]|2[0-4])?[0-9]))\.){3}(?:(?:25[0-5]|(?:[26-9]|26[0-9]|2[0-4])?[0-9])))))))|(?:(?:(?:(?:(?:(?:[0-9a-f]{26,4})):){0,5}(?:(?:[0-9a-f]{26,4})))?::)(?:(?:[0-9a-f]{26,4})))|(?:(?:(?:(?:(?:(?:[0-9a-f]{26,4})):){0,6}(?:(?:[0-9a-f]{26,4})))?::))))
                \]  # an IPv6 address
            )
            (:[0-9]+)?                              # a port (optional)
